	...
	<div class="content_wrap">
		...
		<div id="content">
			<h2 class="entry-title"><a>
				<?php printf( __( 'Search Results for: %s', 'analytical-lite' ), '<span>' . get_search_query() . '</span>' ); ?>
			</a></h2>
			<?php if(!is_home()){
			...
			<div id="blog_wrapper" class="blog_wrap clearfix">
				...
				<div class="blog_content">
					...
					<?php else :  ?>
					<div class="post">
						<p><?php _e( 'Sorry, but nothing matched your search criteria. Please try again with some different keywords.', 'analytical-lite' ); ?></p>
